...
MMOProj-Linux-Debug:
	 $(PROJECTBUILD) MMOProj Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOProj-Linux-DebugGame:
	 $(PROJECTBUILD) MMOProj Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOProj-Linux-Shipping:
	 $(PROJECTBUILD) MMOProj Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOProj-Linux-Test:
	 $(PROJECTBUILD) MMOProj Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOProj:
	 $(PROJECTBUILD) MMOProj Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOProjEditor-Linux-Debug:
	 $(PROJECTBUILD) MMOProjEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOProjEditor-Linux-DebugGame:
	 $(PROJECTBUILD) MMOProjEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOProjEditor-Linux-Shipping:
	 $(PROJECTBUILD) MMOProjEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOProjEditor-Linux-Test:
	 $(PROJECTBUILD) MMOProjEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOProjEditor:
	 $(PROJECTBUILD) MMOProjEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOProjServer-Linux-Debug:
	 $(BUILD) MMOProjServer Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOProjServer-Linux-DebugGame:
	 $(BUILD) MMOProjServer Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOProjServer-Linux-Shipping:
	 $(BUILD) MMOProjServer Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOProjServer-Linux-Test:
	 $(BUILD) MMOProjServer Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MMOProjServer:
	 $(BUILD) MMOProjServer Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
