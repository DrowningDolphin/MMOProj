...
unrealRootPath=/home/gunkol-5/UnrealEngine
MMOProjRootPath=/home/gunkol-5/Documents/Unreal Projects/MMO 4.17

gameProjectFile=/home/gunkol-5/Documents/Unreal Projects/MMO 4.17/MMOProj.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(MMOProjSource.pri)
include(MMOProjHeader.pri)
include(MMOProjConfig.pri)
include(MMOProjIncludes.pri)
include(MMOProjDefines.pri)
...
MMOProj-Linux-Debug.commands = $$build MMOProj Linux Debug  -project="\"$$gameProjectFile\"" $$args
MMOProj-Linux-DebugGame.commands = $$build MMOProj Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MMOProj-Linux-Shipping.commands = $$build MMOProj Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MMOProj-Linux-Test.commands = $$build MMOProj Linux Test  -project="\"$$gameProjectFile\"" $$args
MMOProj.commands = $$build MMOProj Linux Development  -project="\"$$gameProjectFile\"" $$args

MMOProjEditor-Linux-Debug.commands = $$build MMOProjEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
MMOProjEditor-Linux-DebugGame.commands = $$build MMOProjEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MMOProjEditor-Linux-Shipping.commands = $$build MMOProjEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MMOProjEditor-Linux-Test.commands = $$build MMOProjEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
MMOProjEditor.commands = $$build MMOProjEditor Linux Development  -project="\"$$gameProjectFile\"" $$args

MMOProjServer-Linux-Debug.commands = $$build MMOProjServer Linux Debug  -project="\"$$gameProjectFile\"" $$args
MMOProjServer-Linux-DebugGame.commands = $$build MMOProjServer Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MMOProjServer-Linux-Shipping.commands = $$build MMOProjServer Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MMOProjServer-Linux-Test.commands = $$build MMOProjServer Linux Test  -project="\"$$gameProjectFile\"" $$args
MMOProjServer.commands = $$build MMOProjServer Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	MMOProj-Linux-Debug \
	MMOProj-Linux-DebugGame \
	MMOProj-Linux-Shipping \
	MMOProj-Linux-Test \
	MMOProj \
	MMOProjEditor-Linux-Debug \
	MMOProjEditor-Linux-DebugGame \
	MMOProjEditor-Linux-Shipping \
	MMOProjEditor-Linux-Test \
	MMOProjEditor \
	MMOProjServer-Linux-Debug \
	MMOProjServer-Linux-DebugGame \
	MMOProjServer-Linux-Shipping \
	MMOProjServer-Linux-Test \
	MMOProjServer \
